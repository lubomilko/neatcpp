...
@pytest.mark.parametrize("incl_dirs, files_silent, files_in, file_out, file_exp, full_output", TEST_PARAMS)
def test_module(pycpp: PyCpp, incl_dirs: tuple[Path], files_silent: tuple[Path],
...
@pytest.mark.parametrize("incl_dirs, files_silent, files_in, file_out, file_exp, full_output", TEST_PARAMS)
def test_script(monkeypatch, incl_dirs: tuple[Path], files_silent: tuple[Path],
                files_in: tuple[Path], file_out: Path, file_exp: Path,
                full_output: bool) -> None:
